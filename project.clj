(defproject minecljs "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {
              :builds [{:id "devcards"
                        ...
                        :compiler { :main       "minecljs.core"
                                    :asset-path "js/compiled/devcards_out"
                                    :output-to  "resources/public/js/compiled/minecljs_devcards.js"
                       ...
                       {:id "dev"
                        ...
                        :compiler {:main       "minecljs.core"
                                   ...
                                   :output-to  "resources/public/js/compiled/minecljs.js"

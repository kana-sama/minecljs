...
return (new CustomEvent(event_name,(function (){var obj32420 = ({"detail":data});
return obj32420;
})()));
} else {
...
var f = (function (){var pred__32427 = cljs.core._EQ_;
var expr__32428 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__32427.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__32428))){
return (function (p1__32421_SHARP_){
return console.warn(p1__32421_SHARP_);
});
} else {
if(cljs.core.truth_(pred__32427.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__32428))){
return (function (p1__32422_SHARP_){
return console.debug(p1__32422_SHARP_);
});
} else {
if(cljs.core.truth_(pred__32427.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__32428))){
return (function (p1__32423_SHARP_){
return console.error(p1__32423_SHARP_);
});
} else {
return (function (p1__32424_SHARP_){
return console.log(p1__32424_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__32431){
var map__32432 = p__32431;
var map__32432__$1 = cljs.core.__destructure_map.call(null,map__32432);
var opts = map__32432__$1;
var eval_fn = cljs.core.get.call(null,map__32432__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__32433_SHARP_){
return new_def.callback(p1__32433_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__32434){
var vec__32435 = p__32434;
var ky = cljs.core.nth.call(null,vec__32435,(0),null);
...
}catch (e32440){if((e32440 instanceof Error)){
var e = e32440;
return not_found;
} else {
throw e32440;
...
//# sourceMappingURL=utils.js.map?rel=1654704962151

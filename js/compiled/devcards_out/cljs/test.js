...
var G__29211 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__29211,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__29211;
}
}));
...
var len__5766__auto___29216 = arguments.length;
var i__5767__auto___29217 = (0);
while(true){
if((i__5767__auto___29217 < len__5766__auto___29216)){
args__5772__auto__.push((arguments[i__5767__auto___29217]));

var G__29218 = (i__5767__auto___29217 + (1));
i__5767__auto___29217 = G__29218;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq29213){
var G__29214 = cljs.core.first.call(null,seq29213);
var seq29213__$1 = cljs.core.next.call(null,seq29213);
var G__29215 = cljs.core.first.call(null,seq29213__$1);
var seq29213__$2 = cljs.core.next.call(null,seq29213__$1);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29214,G__29215,seq29213__$2);
}));
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__29219_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__29219_SHARP_));
 ...
 */
cljs.test.report = (function (){var method_table__5639__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
var formatter_fn = (function (){var or__5043__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
var temp__5804__auto___29221 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5804__auto___29221)){
var message_29222 = temp__5804__auto___29221;
cljs.core.println.call(null,message_29222);
} else {
}
...
var temp__5804__auto___29223 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5804__auto___29223)){
var message_29224 = temp__5804__auto___29223;
cljs.core.println.call(null,message_29224);
} else {
}
...
var output_dir__$1 = (function (){var G__29225 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__29225,"/"].join('');
} else {
return G__29225;
}
})();
...
var G__29226 = exception.stack;
var G__29226__$1 = (((G__29226 == null))?null:clojure.string.split_lines.call(null,G__29226));
var G__29226__$2 = (((G__29226__$1 == null))?null:cljs.core.get.call(null,G__29226__$1,depth));
if((G__29226__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__29226__$2);
}
} else {
...
var vec__29227 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__29227,(0),null);
var column = cljs.core.nth.call(null,vec__29227,(1),null);
var vec__29230 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__29230,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__29230,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__29230,(2),null);
...
var m__$1 = (function (){var G__29233 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__29237 = (function (){var G__29236 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__29236);
} else {
return G__29236;
}
})();
...
return cljs.core.vary_meta.call(null,G__29238,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__29242 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__29242,(0),null);
var types = vec__29242;
...
return cljs.core.map.call(null,(function (p__29245){
var vec__29246 = p__29245;
var ns = cljs.core.nth.call(null,vec__29246,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__29246,(1),null);
return (function (){
...
var G__29249 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
var seq__29250 = cljs.core.seq.call(null,vars__$1);
var chunk__29251 = null;
var count__29252 = (0);
var i__29253 = (0);
while(true){
if((i__29253 < count__29252)){
var v = cljs.core._nth.call(null,chunk__29251,i__29253);
var temp__5804__auto___29255 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5804__auto___29255)){
var t_29256 = temp__5804__auto___29255;
each_fixture_fn.call(null,((function (seq__29250,chunk__29251,count__29252,i__29253,t_29256,temp__5804__auto___29255,v,each_fixture_fn,G__29249,G__29249__$1,env,once_fixtures,each_fixtures,vec__29246,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_29256)));
});})(seq__29250,chunk__29251,count__29252,i__29253,t_29256,temp__5804__auto___29255,v,each_fixture_fn,G__29249,G__29249__$1,env,once_fixtures,each_fixtures,vec__29246,ns,vars__$1))
);
} else {
}
...
var temp__5804__auto__ = cljs.core.seq.call(null,seq__29250);
if(temp__5804__auto__){
var seq__29250__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__29250__$1)){
var c__5565__auto__ = cljs.core.chunk_first.call(null,seq__29250__$1);
var G__29261 = cljs.core.chunk_rest.call(null,seq__29250__$1);
var G__29262 = c__5565__auto__;
var G__29263 = cljs.core.count.call(null,c__5565__auto__);
var G__29264 = (0);
seq__29250 = G__29261;
...
var v = cljs.core.first.call(null,seq__29250__$1);
var temp__5804__auto___29265__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5804__auto___29265__$1)){
var t_29266 = temp__5804__auto___29265__$1;
each_fixture_fn.call(null,((function (seq__29250,chunk__29251,count__29252,i__29253,t_29266,temp__5804__auto___29265__$1,v,seq__29250__$1,temp__5804__auto__,each_fixture_fn,G__29249,G__29249__$1,env,once_fixtures,each_fixtures,vec__29246,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_29266)));
});})(seq__29250,chunk__29251,count__29252,i__29253,t_29266,temp__5804__auto___29265__$1,v,seq__29250__$1,temp__5804__auto__,each_fixture_fn,G__29249,G__29249__$1,env,once_fixtures,each_fixtures,vec__29246,ns,vars__$1))
);
} else {
}


var G__29267 = cljs.core.next.call(null,seq__29250__$1);
var G__29268 = null;
var G__29269 = (0);
var G__29270 = (0);
seq__29250 = G__29267;
chunk__29251 = G__29268;
count__29252 = G__29269;
i__29253 = G__29270;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29249__$1)].join('')));
...
//# sourceMappingURL=test.js.map?rel=1654516652232

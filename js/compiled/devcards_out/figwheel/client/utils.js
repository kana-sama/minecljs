...
return (new CustomEvent(event_name,(function (){var obj32501 = ({"detail":data});
return obj32501;
})()));
} else {
...
var f = (function (){var pred__32508 = cljs.core._EQ_;
var expr__32509 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__32508.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__32509))){
return (function (p1__32502_SHARP_){
return console.warn(p1__32502_SHARP_);
});
} else {
if(cljs.core.truth_(pred__32508.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__32509))){
return (function (p1__32503_SHARP_){
return console.debug(p1__32503_SHARP_);
});
} else {
if(cljs.core.truth_(pred__32508.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__32509))){
return (function (p1__32504_SHARP_){
return console.error(p1__32504_SHARP_);
});
} else {
return (function (p1__32505_SHARP_){
return console.log(p1__32505_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__32512){
var map__32513 = p__32512;
var map__32513__$1 = cljs.core.__destructure_map.call(null,map__32513);
var opts = map__32513__$1;
var eval_fn = cljs.core.get.call(null,map__32513__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__32514_SHARP_){
return new_def.callback(p1__32514_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__32515){
var vec__32516 = p__32515;
var ky = cljs.core.nth.call(null,vec__32516,(0),null);
...
}catch (e32521){if((e32521 instanceof Error)){
var e = e32521;
return not_found;
} else {
throw e32521;
...
//# sourceMappingURL=utils.js.map?rel=1654516655881
